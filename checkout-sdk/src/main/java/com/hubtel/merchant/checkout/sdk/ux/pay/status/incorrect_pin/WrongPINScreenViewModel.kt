...
internal class WrongPINScreenViewModel(private val checkoutRepository: UnifiedCheckoutRepository): ViewModel() {
    ...
    companion object {
        fun getViewModelFactory(apiKey: String?): ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                val checkoutService = UnifiedCheckoutApiService(apiKey ?: "")
